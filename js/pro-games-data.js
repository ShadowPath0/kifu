...
const PRO_GAMES = [
  {
    id: "shusaku-ear-reddening-1846",
    title: "La partie de l'oreille rouge (Shusaku vs Gennan Inseki)",
    ...
    result: "B+2",
    date: "1846-09-11",
    event: "Château du shogun (Edo), partie annuelle Oshiro-go",
    source: "https://homepages.cwi.nl/~aeb/go/games/games/Shusaku/126.sgf (domaine public)",
    sgf: `(;PB[Yasuda Shusaku]BR[4d]PW[Inoue Gennan Inseki]WR[8d]RE[B+2]DT[1846-09-11,14,15]
